...
const mathFacts = [
    ...
    { label: "Commutative Algebra", latex: "\\[I = \\bigcap_{j=1}^n q_j,\\quad q_j \\text{ primary.}\\]" },
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (searchInput) {
        const searchableItems = [
            ...
            { label: "Expository Writing", url: "expository.html", keywords: ["expository", "writing", "articles"] },
            { label: "Olympiad", url: "olympiad.html", keywords: ["olympiad", "competition", "problems"] },
            { label: "Undergraduate", url: "undergraduate.html", keywords: ["undergraduate", "college", "math"] },
            { label: "Graduate", url: "graduate.html", keywords: ["graduate", "advanced", "research"] },
            { label: "Research", url: "research.html", keywords: ["research", "interests", "projects"] },
            ...
            // Precalculus 11 Lecture Notes
            { label: "Precalculus 11", url: "courses/precalculus-11.html", keywords: ["precalculus", "grade 11", "high school", "math 11"] },
            { label: "Sequences and Series", url: "courses/lecture-notes-sequences-series.html", keywords: ["sequences", "series", "arithmetic", "geometric", "sigma"] },
            { label: "Trigonometry", url: "courses/lecture-notes-trigonometry-angles.html", keywords: ["trigonometry", "angles", "unit circle", "sine", "cosine", "tangent", "sine law", "cosine law"] },
            { label: "Quadratic Functions", url: "courses/lecture-notes-quadratic-functions.html", keywords: ["quadratic", "parabola", "vertex", "transformations", "functions"] },
            { label: "Quadratic Equations", url: "courses/lecture-notes-quadratic-equations.html", keywords: ["quadratic", "equations", "factoring", "formula", "discriminant"] },
            { label: "Radical Expressions", url: "courses/lecture-notes-radical-expressions.html", keywords: ["radical", "square root", "simplifying", "rationalizing"] },
            { label: "Rational Expressions", url: "courses/lecture-notes-rational-expressions.html", keywords: ["rational", "fractions", "algebraic", "expressions"] },
            { label: "Absolute Value", url: "courses/lecture-notes-absolute-value.html", keywords: ["absolute", "value", "reciprocal", "functions"] },
            { label: "Systems of Equations", url: "courses/lecture-notes-systems-of-equations.html", keywords: ["systems", "equations", "substitution", "elimination"] },
            { label: "Inequalities", url: "courses/lecture-notes-inequalities.html", keywords: ["inequalities", "linear", "quadratic", "graphing"] },
            // Problem Sets
            { label: "Problem Set 1", url: "courses/problem-set-1.html", keywords: ["problem set", "sequences", "series", "practice"] },
            { label: "Problem Set 2", url: "courses/problem-set-2.html", keywords: ["problem set", "trigonometry", "angles", "practice"] },
            { label: "Problem Set 3", url: "courses/problem-set-3.html", keywords: ["problem set", "quadratic", "functions", "practice"] },
            { label: "Problem Set 4", url: "courses/problem-set-4.html", keywords: ["problem set", "quadratic", "equations", "practice"] },
            { label: "Problem Set 5", url: "courses/problem-set-5.html", keywords: ["problem set", "radical", "rational", "absolute", "practice"] },
            { label: "Problem Set 6", url: "courses/problem-set-6.html", keywords: ["problem set", "systems", "inequalities", "practice"] },
            // Mathematics 10
            { label: "Mathematics 10", url: "courses/mathematics-10.html", keywords: ["mathematics 10", "grade 10", "high school", "math 10"] },
            { label: "Linear Relations M10", url: "courses/lecture-notes-linear-relations.html", keywords: ["linear", "relations", "slope", "lines", "math 10"] },
            { label: "Systems M10", url: "courses/lecture-notes-systems-of-equations-m10.html", keywords: ["systems", "equations", "math 10"] },
            { label: "Quadratics M10", url: "courses/lecture-notes-quadratic-functions-m10.html", keywords: ["quadratic", "parabola", "math 10"] },
            { label: "M10 Problem Set 1", url: "courses/problem-set-1-m10.html", keywords: ["problem set", "linear", "math 10"] },
            { label: "M10 Problem Set 2", url: "courses/problem-set-2-m10.html", keywords: ["problem set", "quadratic", "math 10"] },
            { label: "Trigonometry M10", url: "courses/lecture-notes-trigonometry-m10.html", keywords: ["trigonometry", "sine", "cosine", "tangent", "math 10"] },
            { label: "Factoring M10", url: "courses/lecture-notes-factoring-m10.html", keywords: ["factoring", "polynomials", "math 10"] },
            { label: "Roots M10", url: "courses/lecture-notes-roots-m10.html", keywords: ["roots", "radicals", "exponents", "math 10"] },
            { label: "Relations M10", url: "courses/lecture-notes-relations-m10.html", keywords: ["relations", "functions", "math 10"] },
            { label: "Linear Functions M10", url: "courses/lecture-notes-linear-functions-m10.html", keywords: ["linear", "functions", "slope", "math 10"] },
            { label: "M10 Problem Set 3", url: "courses/problem-set-3-m10.html", keywords: ["problem set", "trigonometry", "math 10"] },
            { label: "M10 Problem Set 4", url: "courses/problem-set-4-m10.html", keywords: ["problem set", "factoring", "radicals", "math 10"] },
            { label: "M10 Problem Set 5", url: "courses/problem-set-5-m10.html", keywords: ["problem set", "relations", "functions", "math 10"] },
            { label: "M10 Problem Set 6", url: "courses/problem-set-6-m10.html", keywords: ["problem set", "linear", "functions", "math 10"] },
            { label: "M10 Problem Set 7", url: "courses/problem-set-7-m10.html", keywords: ["problem set", "systems", "equations", "math 10"] },
            // Precalculus 12
            { label: "Precalculus 12", url: "courses/precalculus-12.html", keywords: ["precalculus", "grade 12", "high school", "math 12"] },
            { label: "Function Transformations P12", url: "courses/lecture-notes-function-transformations-p12.html", keywords: ["function", "transformations", "math 12"] },
            { label: "Radical Functions P12", url: "courses/lecture-notes-radical-functions-p12.html", keywords: ["radical", "functions", "math 12"] },
            { label: "Polynomial Functions P12", url: "courses/lecture-notes-polynomial-functions-p12.html", keywords: ["polynomial", "functions", "math 12"] },
            { label: "Trigonometry Unit Circle P12", url: "courses/lecture-notes-trigonometry-unit-circle-p12.html", keywords: ["trigonometry", "unit circle", "math 12"] },
            { label: "Trigonometric Functions P12", url: "courses/lecture-notes-trigonometric-functions-p12.html", keywords: ["trigonometric", "functions", "math 12"] },
            { label: "Trigonometric Identities P12", url: "courses/lecture-notes-trigonometric-identities-p12.html", keywords: ["trigonometric", "identities", "math 12"] },
            { label: "Exponential Logarithmic P12", url: "courses/lecture-notes-exponential-logarithmic-p12.html", keywords: ["exponential", "logarithmic", "math 12"] },
            { label: "Rational Functions P12", url: "courses/lecture-notes-rational-functions-p12.html", keywords: ["rational", "functions", "math 12"] },
            { label: "Function Operations P12", url: "courses/lecture-notes-function-operations-p12.html", keywords: ["function", "operations", "math 12"] },
            { label: "Permutations Combinations P12", url: "courses/lecture-notes-permutations-combinations-p12.html", keywords: ["permutations", "combinations", "math 12"] },
            { label: "P12 Problem Set 1", url: "courses/problem-set-1-p12.html", keywords: ["problem set", "function", "math 12"] },
            { label: "P12 Problem Set 2", url: "courses/problem-set-2-p12.html", keywords: ["problem set", "radical", "math 12"] },
            { label: "P12 Problem Set 3", url: "courses/problem-set-3-p12.html", keywords: ["problem set", "polynomial", "math 12"] },
            { label: "P12 Problem Set 4", url: "courses/problem-set-4-p12.html", keywords: ["problem set", "trigonometry", "math 12"] },
            { label: "P12 Problem Set 5", url: "courses/problem-set-5-p12.html", keywords: ["problem set", "trigonometric", "math 12"] },
            { label: "P12 Problem Set 6", url: "courses/problem-set-6-p12.html", keywords: ["problem set", "exponential", "math 12"] },
